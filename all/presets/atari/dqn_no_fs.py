...
from all.presets.atari.models import qlassifier_dqn
...
class DQNNoFSAtariPreset(Preset):
    """
...
dqn_no_fs = PresetBuilder('dqn_no_fs', default_hyperparameters, DQNNoFSAtariPreset)
